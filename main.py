...
def run_lightweight_migrations():
    ...
    already-deployed database (e.g. an existing Render SQLite file from
    before this change) they need to be added once by hand. This does
    that, safely and idempotently, for both SQLite and Postgres.
    """
